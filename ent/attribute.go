...
type AttributeEdges struct {
	...
	// ProductAttributes holds the value of the product_attributes edge.
...
// was not loaded in eager-loading.
func (e AttributeEdges) ProductAttributesOrErr() ([]*ProductAttribute, error) {
	if e.loadedTypes[1] {
		return e.ProductAttributes, nil
	}
	return nil, &NotLoadedError{edge: "product_attributes"}
}
...
func (_m *Attribute) QueryOptions() *AttributeOptionQuery {
	return NewAttributeClient(_m.config).QueryOptions(_m)
}

// QueryProductAttributes queries the "product_attributes" edge of the Attribute entity.
func (_m *Attribute) QueryProductAttributes() *ProductAttributeQuery {
	return NewAttributeClient(_m.config).QueryProductAttributes(_m)
}
